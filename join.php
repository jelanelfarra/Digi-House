...
<head>
    ...
    <title>DIGI HOUSE| Join Us</title>
...
<!-- Start Carousel-->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="img/join.jpg" alt="pic1" class="imges">
   ...
   <section class="join text-center">
       <div class="container">
           <h1 class="h1 head-after"> How Can You Join Us!</h1>
           <div class="row">
             <div class="col-lg-6 text-left">
               <ul>
             <p class="lead wow fadeInDown"data-wow-duration="1s">At <span>Digi House</span> we are always looking for the new talents who have the creativity and the well to help, support, and give everything they can to satisfy the customers and to build the best workers team.  If you are looking forward to be one of our team, and another family member of us, please fill in your data below:</p>
             <a href=" https://docs.google.com/forms/d/1S7oSTadvVG4XLXnoWiaKNDNKzs-wHCF2fvbADNc1GBo/edit"target="_blank"><button class="btn btn-success wow fadeInDown"data-wow-duration="1s">Translator</button></a>
             <a href="https://docs.google.com/forms/d/19LTu6xjPX0JdPdCoRvDM6YYHzR6RvmbLFXn2fZ1jhEw/edit"target="_blank"><button class="btn btn-success wow fadeInDown"data-wow-duration="1.5s">Designer</button></a>
             <a href="https://docs.google.com/forms/d/1LvgmuqtuNrSIFwkd8izovBJ0v_JMtw-pccpZPhXtXQE/edit"target="_blank"><button class="btn btn-success wow fadeInDown"data-wow-duration="2s">Developer</button></a>
             </ul>
             </div>
